...
func main() {
	...
	flag.StringVar(&controllers.DefaultD8ReleaseSpec, "default-d8-release-spec", "RELEASE-2022.01.25T10-50-33Z", "The default releaseSpec value to be passed to the DrupalSites")
	flag.StringVar(&controllers.DefaultD9ReleaseSpec, "default-d9-release-spec", "RELEASE-2022.01.25T10-50-27Z", "The default releaseSpec value to be passed to the DrupalSites")
