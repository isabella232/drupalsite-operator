...
func main() {
	...
	flag.StringVar(&controllers.DefaultD8ReleaseSpec, "default-d8-release-spec", "RELEASE-2021.11.04T11-30-27Z", "The default releaseSpec value to be passed to the DrupalSites")
