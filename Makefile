...
# drupalsite-operator-bundle:$VERSION and drupalsite-operator-catalog:$VERSION.
...
# For CERN use case, let's use the tag latest.
...
# https://github.com/operator-framework/community-operators/blob/master/docs/packaging-operator.md#updating-your-existing-operator
# mode was changed to replace.
.PHONY: catalog-build
catalog-build: opm
