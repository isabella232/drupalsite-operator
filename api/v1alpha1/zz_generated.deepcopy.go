...
func (in *AvailableBackups) DeepCopyInto(out *AvailableBackups) {
	*out = *in
	if in.Backups != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailableBackups.
func (in *AvailableBackups) DeepCopy() *AvailableBackups {
	if in == nil {
		return nil
	}
	out := new(AvailableBackups)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DrupalSiteStatus) DeepCopyInto(out *DrupalSiteStatus) {
	*out = *in
	...
	in.AvailableBackups.DeepCopyInto(&out.AvailableBackups)
}
